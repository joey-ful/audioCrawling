...
(function (TheDatepicker) {
    var Day = (function () {
        function Day(date) {
            ...
            this.isWeekend = this.dayOfWeek === TheDatepicker.DayOfWeek.토 || this.dayOfWeek === TheDatepicker.DayOfWeek.일;
        }
...
(function (TheDatepicker) {
    var DayOfWeek;
    (function (DayOfWeek) {
        DayOfWeek[DayOfWeek["일"] = 0] = "일";
        DayOfWeek[DayOfWeek["월"] = 1] = "월";
        DayOfWeek[DayOfWeek["화"] = 2] = "화";
        DayOfWeek[DayOfWeek["수"] = 3] = "수";
        DayOfWeek[DayOfWeek["목"] = 4] = "목";
        DayOfWeek[DayOfWeek["금"] = 5] = "금";
        DayOfWeek[DayOfWeek["토"] = 6] = "토";
    ...
    (function (Month) {
        ...
        Month[Month["8월"] = 7] = "8월";
        Month[Month["9월"] = 8] = "9월";
        Month[Month["10월"] = 9] = "10월";
        Month[Month["11월"] = 10] = "11월";
        Month[Month["12월"] = 11] = "12월";
...
(function (TheDatepicker) {
    ...
    var Options = (function () {
        function Options(translator) {
            ...
            this.firstDayOfWeek_ = TheDatepicker.DayOfWeek.월;
...
(function (TheDatepicker) {
    var Template_ = (function () {
        ...
        Template_.prototype.createTableHeaderCellElement_ = function (viewModel, dayOfWeek) {
            ...
            if (dayOfWeek === TheDatepicker.DayOfWeek.토 || dayOfWeek === TheDatepicker.DayOfWeek.일) {
